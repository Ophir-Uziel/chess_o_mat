...
real_moves = []
for line in open('moves2.txt'):
    move = line.rstrip('\n')
    real_moves.append((move[0:2], move[2:4]))
gameloop = game_loop.game_loop(angles_num=2, real_moves_if_test=real_moves,imgs_if_test=['angle3/','angle4/'])
gameloop.main()

#super_tester('moves2.txt' ,['angle3/', 'angle4/'], WITH_SAVES)
